...
# NOTE: RAG helpers are not imported here because your installed LangChain
# package layout may not expose langchain.chains.*.
# API endpoint /api/chat does not rely on this Streamlit server.py for responses.
...
def initialize_documents():
    loader = PyPDFLoader('rgukt_datasets/Academic_Regulations_Hand_Book.pdf')
